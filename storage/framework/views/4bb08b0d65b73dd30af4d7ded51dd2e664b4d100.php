									    ...
									    <div class="row">
										  <div class="col-md-12">
											...
											<div class="form-group mt-2">
                                               <label>Tag</label>
                                            <input id="add-category-tag" type="text" value="<?php echo e($c['category']); ?>" name="category" value="" placeholder="Tag e.g tablets" class="form-control">
                                            </div>
											 <div class="form-group">
                                             <label>Description</label>
                                               <textarea id="add-category-description" name="description" class="form-control" placeholder="Description" rows="8"><?php echo $cd['description']; ?></textarea>
                                            </div>
										  </div>
										</div>
                                       </div>
									    ...
									    <div class="row">
										  <div class="col-md-12">
											...
											<div class="form-group mt-2">
                                              ...
                                              <input id="add-category-meta-title" name="meta_title" type="text" value="<?php echo e($cd['meta_title']); ?>" placeholder="Meta tag title" class="form-control">
                                            </div>
											<div class="form-group mt-2">
                                               <label>Meta tag Description</label>
                                               <textarea id="add-category-meta-description" name="meta_description" class="form-control" placeholder="Meta tag description" rows="8"><?php echo $cd['meta_description']; ?></textarea>
                                            </div>
											<div class="form-group mt-2">
                                              <label>Meta tag keywords</label>
                                              <input id="add-category-meta-keywords" name="meta_keywords" value="<?php echo e($cd['meta_keywords']); ?>" type="text" placeholder="Meta tag keywords" class="form-control">
                                            </div>
											<div class="form-group mt-2">
                                              <label>Image</label>
									    ...
									    <div class="row">
										  <div class="col-md-12">
										    <div class="form-group">
                                              ...
                                              <input id="add-category-seo-keywords" name="seo_keywords" type="text" value="<?php echo e($cd['seo_keywords']); ?>" placeholder="Keywords" class="form-control">
                                            </div>
