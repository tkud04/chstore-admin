...
<?php echo $__env->make('page-header',['title' => "Products",'subtitle' => $title], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
$(document).ready(() => {
//$('#pa-loading').hide();
let postProductDescriptionEditor = new Simditor({
